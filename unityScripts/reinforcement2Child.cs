...
public class reinforcement2Child : MonoBehaviour
{
    ...
    public void Initialise2(int hiddenLayerCount, int hiddenNeuronCount)
    {
    ...
    public void InitialiseHidden2(int hiddenLayerCount, int hiddenNeuronCount)
    {
        inputLayer.Clear();
        hiddenLayers.Clear();
        outputLayer.Clear();
    ...
    public (float, float,float) RunNetwork2(float a, float b, float c, float d)
    {
        inputLayer[0, 0] = a;
        inputLayer[0, 1] = b;
        inputLayer[0, 2] = c;
